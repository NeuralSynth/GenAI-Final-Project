      ...
      <div className="glass-card p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-100">Team Contributions</h3>
              <p className="text-[10px] text-slate-400 mt-0.5">Analysis distribution across team members</p>
            </div>
          </div>
          <span className="text-xs font-bold text-slate-300 bg-navy-800/60 px-3 py-1.5 rounded-lg">
            ...
            return (
              <div key={contributor.id} className="space-y-2.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-slate-100">{contributor.name}</p>
                    <p className="text-[9px] text-slate-400">{contributor.role}</p>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-[10px] font-bold text-slate-200">{contributor.contributions}</span>
                    <span className="text-[9px] text-slate-400">{percentage}%</span>
                  </div>
                  <div className="contribution-bar">
                    <div 
                      className="contribution-fill bg-gradient-to-r from-purple-500 to-purple-400" 
                    ...
                    <tr key={contract._id} className="hover:bg-navy-800/25 transition-colors group">
                      ...
                      <td className="py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-300 text-xs">{assignedAnalyst.name}</span>
                        </div>
                      </td>
                      <td className="py-3">
